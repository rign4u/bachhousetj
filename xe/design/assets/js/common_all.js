...
var initPage = {
  ...
  init: function() {
    ...
    script += '<script type="text/javascript" src="/xe/design/assets/js/vendors/swiper.min.js"></script>';

    script += '<script type="text/javascript" src="/xe/design/assets/js/common.js"></script>';
    script += '<script type="text/javascript" src="/xe/design/assets/js/main.js"></script>';
